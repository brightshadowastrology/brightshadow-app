  ...
  return (
    <Form.Field className="mb-(--custom-md)" name={name}>
      ...
      <PasswordToggleField.Root>
        <div className="focus:border-primary-400 focus:ring-primary-400 flex w-full justify-between rounded-md border border-gray-300 px-(--custom-sm) py-(--custom-xs) text-secondary-400">
